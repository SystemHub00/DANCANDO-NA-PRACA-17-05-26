...
# ──────────────────────────────────────────────
# CATÁLOGO DE OPÇÕES DO EVENTO
# ──────────────────────────────────────────────
COURSE_OPTIONS = [
    {
        "id": "1",
        "local": "PRAÇA JERUSALÉM (PRAIA DA BICA) - JARDIM GUANABARA",
        "curso": "TODOS OS RITMOS",
        "turma": "AULÃO DE DANÇA",
        "dias_aula": "Domingo",
        "horario": "17h",
        "data_inicio": "17/05/2026",
        "encerramento": "⚠️Em caso de chuva pode ser cancelado",
        "endereco_curso": "📍Praça Jerusalém, Jardim Guanabara, Rio de Janeiro - RJ, 21940-460",
    },
]
...
<head>
    ...
    <style>
        ...
        @media (max-width: 640px) {
            ...
            .actions, .action-button, .protocol-box, .next-steps, .wizard-label, .wizard-track {
                width: 100% !important;
                max-width: 100% !important;
            }
            img, svg {
